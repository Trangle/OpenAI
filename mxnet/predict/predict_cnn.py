...
model_prefixes = ['H:/data/bot_animal/models/net_resnet-full-101', 'H:/data/bot_animal/models/net_incep-res-2']
model_rounds = [[18],[106]]
...
def parse_args():
    ...
    parser.add_argument('--model-prefix', type=str, default= "H:/data/bot_animal/models/net_bot-resnetV1-1",
                        help='the prefix of the model to load')
    parser.add_argument('--num-round', type=int,default= 187,
...
if __name__ == '__main__':
    ...
    #     count += 1
    #     pre = predictions[i]
    #     pred = np.argsort(pre)[::-1]
    #     curr_label = int(label_o[i])
