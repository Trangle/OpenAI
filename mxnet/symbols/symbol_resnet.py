...
def get_symbol(
    ...
    pool = mx.symbol.Pooling(data=body, kernel=pool_kernel, pool_type='avg', name='pool1')
...
if __name__ == '__main__':
    net = get_symbol(12, num_level=5, num_block=5)
    shape = {'softmax_label': (32, 12), 'data': (32, 3, 224, 224)}
    mx.viz.plot_network(net, title='resnet-52', format='pdf', shape=shape).render('resnet-52')
